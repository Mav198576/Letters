...
with tab2:
    st.header("📇 Leads")
    search_leads = st.text_input("🔍 Search Leads", placeholder="Name or email", key="search_leads_tab2")
...
with tab3:
    st.header("👥 Clients")
    search_clients = st.text_input("🔍 Search Clients", placeholder="Name or email", key="search_clients_tab3")
