...
with tab2:
    st.header("📇 Leads")
    search_leads = st.text_input("🔍 Search Leads", placeholder="Name or email", key="search_leads_line_38")
...
with tab3:
    ...
    search_clients = st.text_input("🔍 Search Clients", placeholder="Name or email", key="search_clients_line_68")
...
uploaded_file = st.file_uploader("Upload JSON credit report", type="json", key="upload_json_report_main")
...
with tab1:
    ...
    search_clients = st.text_input("🔍 Search Clients", placeholder="Name or email", key="search_clients_line_219")
